...
Desde Windows Server con entorno gráfico, crearemos un usuario con los permisos de administrador en el que se llamará `admin_hbf`. Para crearlo lo haremos desde PowerShell.
